...
real*8 :: xi,mu_eg,lam,omega_c,beta,part,mu_dd,mu_aa,R_0,diab
...
!------------------------  rate for each channel with particular dg--------------------
 ...
 do g = 1,nstep
   ...
   do n = 1,nfock
      ...
      !write(1000,*) "n=",real(n),  exp(-beta*real(n)*omega_c)
   ...
   do g = 1,nstep
      ...
      open(unit=110, file="with_wc0.2ev_g0.005_vda40mev.out")
